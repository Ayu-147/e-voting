...
<body>
    ...
    <div id="content">
        ...
        <th height="41" colspan="2" scope="col">
            <h1>
                <center>
                    <span class="style2">To View Result you must choose the Type of Election to view result</span>
                </center>
            </h1>
        </th>
        <p>&nbsp;</p>
                        ...
                        <table width="459" height="103" align="center">
                            <tr>
                                <td width="305" height="55">
                                    <div align="center" class="style8">PRIME MINISTER RESULT</div>
                                </td>
                                <td width="142">
                                    <label>
                                        <div align="center">
                            ...
                            <tr>
                                <td height="40">
                                    <div align="center" class="style8">CHIEF MINISTER RESULT</div>
                                </td>
                                <td>
                                    <div align="center">
                            ...
                            <tr>
                                <td width="305" height="55">
                                    <div align="center" class="style8">MLA RESULT</div>
                                </td>
                                <td width="142">
                                    <label>
                                        <div align="center">
